					...
					<form action="#" id="ufrm" class="form-inline">
						...
						<table class="table table-bordered" style="width: 400px;">
							...
							<tr>
								...
								</select> <img src="" id="umyphoto" width="60" height="60"> <script>
